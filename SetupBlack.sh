...
versao() {
echo -e "                                   \e[97mVersão do SetupOrion: \e[32mv. 2.5.6\e[0m                                  "
echo -e "\e[32mblackhat.vip/wp/pv      \e[97m<----- Grupos no WhatsApp ----->     \e[32mblackhat.vip/wp/pv\e[0m"
}
...
direitos_setup() {
    ...
    echo -e "$amarelo=  $branco   mas deve sempre declarar que OrionDesign (contato@blackhat.vip) é o autor original  $amarelo  =\e[0m"
    echo -e "$amarelo=  $branco           destes códigos e atribuir um link para https://blackhat.vip/setup           $amarelo  =\e[0m"
    echo -e "$amarelo=                                                                                                 =\e[0m"
    echo -e "$amarelo===================================================================================================\e[0m"
    echo ""
    echo ""
...
direitos_instalador() {
    ...
    echo -e "$amarelo=  $branco aplicação disponíveis aqui. Este Setup é licenciado sob a Licença MIT (MIT). Você pode usar,$amarelo =\e[0m"
    echo -e "$amarelo=  $branco  copiar, modificar, integrar, publicar, distribuir e/ou vender cópias dos produtos finais,  $amarelo  =\e[0m"
    echo -e "$amarelo=  $branco   mas deve sempre declarar que OrionDesign (contato@spyhacker.pro) é o autor original       $amarelo  =\e[0m"
    echo -e "$amarelo=  $branco           destes códigos e atribuir um link para https://blackhat.vip/wp/pv                 $amarelo  =\e[0m"
    echo -e "$amarelo=                                                                                                 =\e[0m"
    echo -e "$amarelo===================================================================================================\e[0m"
    echo ""
    echo ""
...
creditos_msg() {
    ...
    echo -e "$amarelo=                                                                                                 $amarelo=\e[0m"
    echo -e "$amarelo=                                     $amarelo pix@blackhat.vip                                     $amarelo=\e[0m"
    echo -e "$amarelo=                                                                                                 $amarelo=\e[0m"
    echo -e "$amarelo=                  $branco Se precisar de ajuda/mentoria ou quiser deixar seu feedback                   $amarelo=\e[0m"
    echo -e "$amarelo=                        $branco Nossa comunidade:$amarelo https://blackhat.vip/wp/pv                        $amarelo=\e[0m"
    echo -e "$amarelo=                                                                                                 $amarelo=\e[0m"
    echo -e "$amarelo=                            $branco ou via WhatsApp (comunidade SetupBlackHat)                             $amarelo=\e[0m"
    echo -e "$amarelo=      $amarelo https://blackhat.vip/wp/pv $branco<-- ou -->$amarelo blackhat.vip/wp/pv      $amarelo=\e[0m"
    echo -e "$amarelo=                                                                                                 $amarelo=\e[0m"
    echo -e "$amarelo===================================================================================================\e[0m"
    echo ""
    echo ""
...
menu_instalador_pg_1(){
    ...
    echo -e "${amarelo}[ 20 ]${reset} - ${branco}Woofed CRM                             ${verde}| ${reset}  ${amarelo}[ 43 ]${reset} - ${branco}LangFlow ${verde}[NOVO]${reset}"
    echo -e "${amarelo}[ 21 ]${reset} - ${branco}Formbricks                             ${verde}| ${reset}  ${amarelo}[ 44 ]${reset} - ${branco}OpenProject ${verde}[NOVO]${reset}"
    echo -e ""
...
menu_instalador_pg_2(){
    echo -e "${amarelo}[ 45 ]${reset} - ${branco}ZEP ${verde}[NOVO]                             ${verde}| ${reset}  ${amarelo}[ 68 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 46 ]${reset} - ${branco}HumHub ${verde}[NOVO]                          ${verde}| ${reset}  ${amarelo}[ 69 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 47 ]${reset} - ${branco}EM BREVE...                            ${verde}| ${reset}  ${amarelo}[ 70 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 48 ]${reset} - ${branco}EM BREVE...                            ${verde}| ${reset}  ${amarelo}[ 71 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 49 ]${reset} - ${branco}EM BREVE...                            ${verde}| ${reset}  ${amarelo}[ 72 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 50 ]${reset} - ${branco}EM BREVE...                            ${verde}| ${reset}  ${amarelo}[ 73 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 51 ]${reset} - ${branco}EM BREVE...                            ${verde}| ${reset}  ${amarelo}[ 74 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 52 ]${reset} - ${branco}EM BREVE...                            ${verde}| ${reset}  ${amarelo}[ 75 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 53 ]${reset} - ${branco}EM BREVE...                            ${verde}| ${reset}  ${amarelo}[ 76 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 54 ]${reset} - ${branco}EM BREVE...                            ${verde}| ${reset}  ${amarelo}[ 77 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 55 ]${reset} - ${branco}EM BREVE...                            ${verde}| ${reset}  ${amarelo}[ 78 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 56 ]${reset} - ${branco}EM BREVE...                            ${verde}| ${reset}  ${amarelo}[ 79 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 57 ]${reset} - ${branco}EM BREVE...                            ${verde}| ${reset}  ${amarelo}[ 80 ]${reset} - ${branco}EM BREVE...${reset}"
    echo -e "${amarelo}[ 58 ]${reset} - ${branco}EM BREVE...                            ${verde}| ${reset}  ${amarelo}[ 81 ]${reset} - ${branco}EM BREVE...${reset}"
...
criar_arquivo() {
    ...
    read -p "Digite a Url do Portainer (ex: portainer.blackhat.vip): " PORTAINER_URL
    echo ""
...
wait_supabase(){
    echo "Este processo pode demorar um pouco, se passar de 5 minutos cancele... por que deu ruim..."
    while true; do
        # Verifica se o serviço supabase está ativo
...
wait_ntfy(){
    echo "Este processo pode demorar um pouco, se passar de 5 minutos cancele... por que deu ruim..."
    while true; do
        # Verifica se o serviço ntfy está ativo
        if docker service ls --filter "name=ntfy" | grep "1/1"; then
            sleep 10
            break
        fi
...
wait_lowcoder(){
    echo "Este processo pode demorar um pouco, se passar de 5 minutos cancele... por que deu ruim..."
    while true; do
        # Verifica se o serviço lowcoder está ativo
        if docker service ls --filter "name=lowcoder" | grep "1/1"; then
            sleep 10
            break
        fi
...
wait_humhub(){
    echo "Este processo pode demorar um pouco, se passar de 5 minutos cancele... por que deu ruim..."
    while true; do
        # Verifica se o serviço humhub está ativo
        if docker service ls --filter "name=humhub" | grep "1/1"; then
            sleep 10
            break
        fi
...
wait_langflow(){
    echo "Este processo pode demorar um pouco, se passar de 5 minutos cancele... por que deu ruim..."
    while true; do
        # Verifica se o serviço langflow está ativo
        if docker service ls --filter "name=langflow" | grep "1/1"; then
            sleep 10
            break
        fi
...
wait_openproject(){
    echo "Este processo pode demorar um pouco, se passar de 5 minutos cancele... por que deu ruim..."
    while true; do
        # Verifica se o serviço zep está ativo
        if docker service ls --filter "name=openproject" | grep "1/1"; then
            sleep 10
            break
        fi
...
wait_zep(){
    ...
    while true; do
        # Verifica se o serviço zep está ativo
        if docker service ls --filter "name=zep" | grep "1/1"; then
            sleep 10
            break
        fi
...
criar_banco_postgres_evolution() {
    while :; do
        if docker ps -q --filter "name=postgres" | grep -q .; then
            CONTAINER_ID=$(docker ps -q --filter "name=postgres")

            # Verificar se o banco de dados já existe
            docker exec "$CONTAINER_ID" psql -U postgres -lqt | cut -d \| -f 1 | grep -qw "evolution"

            if [ $? -eq 0 ]; then
                echo "O banco de dados evolution já existe."

                read -p "Deseja apagar e criar um novo banco de dados? (Y/N): " resposta
                if [ "$resposta" == "Y" ] || [ "$resposta" == "y" ]; then
                    # Apagar o banco de dados
                    docker exec "$CONTAINER_ID" psql -U postgres -c "DROP DATABASE IF EXISTS evolution;"
                    echo "Banco de dados evolution apagado com sucesso."
...
criar_banco_postgres_langflow() {
    while :; do
        if docker ps -q --filter "name=postgres" | grep -q .; then
            CONTAINER_ID=$(docker ps -q --filter "name=postgres")

            # Verificar se o banco de dados já existe
            docker exec "$CONTAINER_ID" psql -U postgres -lqt | cut -d \| -f 1 | grep -qw "langflow"

            if [ $? -eq 0 ]; then
                echo "O banco de dados langflow já existe."

                read -p "Deseja apagar e criar um novo banco de dados? (Y/N): " resposta
                if [ "$resposta" == "Y" ] || [ "$resposta" == "y" ]; then
                    # Apagar o banco de dados
                    docker exec "$CONTAINER_ID" psql -U postgres -c "DROP DATABASE IF EXISTS langflow;"
                    echo "Banco de dados langflow apagado com sucesso."
                    
                    # Criar o banco de dados novamente
                    docker exec "$CONTAINER_ID" psql -U postgres -c "CREATE DATABASE langflow;"
                    
                    echo "Banco de dados langflow criado com sucesso."
                else
                    echo "Usando o banco de dados existente."
                fi
                break
...
criar_banco_postgres_openproject() {
    while :; do
        if docker ps -q --filter "name=postgres" | grep -q .; then
            CONTAINER_ID=$(docker ps -q --filter "name=postgres")

            # Verificar se o banco de dados já existe
            docker exec "$CONTAINER_ID" psql -U postgres -lqt | cut -d \| -f 1 | grep -qw "openproject"

            if [ $? -eq 0 ]; then
                echo "O banco de dados openproject já existe."

                read -p "Deseja apagar e criar um novo banco de dados? (Y/N): " resposta
                if [ "$resposta" == "Y" ] || [ "$resposta" == "y" ]; then
                    # Apagar o banco de dados
                    docker exec "$CONTAINER_ID" psql -U postgres -c "DROP DATABASE IF EXISTS openproject;"
                    echo "Banco de dados openproject apagado com sucesso."
                    
                    # Criar o banco de dados novamente
                    docker exec "$CONTAINER_ID" psql -U postgres -c "CREATE DATABASE openproject;"
                    
                    echo "Banco de dados openproject criado com sucesso."
                else
                    echo "Usando o banco de dados existente."
                fi
                break
...
## Criar banco do Zep
criar_banco_pgvector_zep() {
    while :; do
        if docker ps -q --filter "name=pgvector" | grep -q .; then
            CONTAINER_PGVECTOR_ID=$(docker ps -q --filter "name=pgvector")

            # Verificar se o banco de dados já existe
            docker exec "$CONTAINER_PGVECTOR_ID" psql -U postgres -lqt | cut -d \| -f 1 | grep -qw "zep"


            if [ $? -eq 0 ]; then
                echo "O banco de dados zep já existe."

                read -p "Deseja apagar e criar um novo banco de dados? (Y/N): " resposta
                if [ "$resposta" == "Y" ] || [ "$resposta" == "y" ]; then
                    # Apagar o banco de dados
                    docker exec "$CONTAINER_PGVECTOR_ID" psql -U postgres -c "DROP DATABASE IF EXISTS zep;"
                    echo "Banco de dados zep apagado com sucesso."
                    
                    # Criar o banco de dados novamente
                    docker exec "$CONTAINER_PGVECTOR_ID" psql -U postgres -c "CREATE DATABASE zep;"
                    
                    echo "Banco de dados zep criado com sucesso."
                else
                    echo "Usando o banco de dados existente."
                fi
                break
...
criar_banco_mysql_strapi() {
    ...
    while :; do
        if CONTAINER_ID=$(docker ps -q --filter "name=mysql"); then
            if [ -n "$CONTAINER_ID" ]; then
                # Verificar se o banco de dados já existe
                if docker exec -it "$CONTAINER_ID" mysql -u root -p"$senha_mysql" -e "SHOW DATABASES LIKE 'strapi';" | grep -qw "strapi"; then
                    echo "O banco de dados strapi já existe."

                    read -p "Deseja apagar e criar um novo banco de dados? (Y/N): " resposta
                    if [ "$resposta" == "Y" ] || [ "$resposta" == "y" ]; then
                        # Apagar o banco de dados
                        docker exec -it "$CONTAINER_ID" mysql -u root -p"$senha_mysql" -e "DROP DATABASE strapi;"
                        echo "Banco de dados strapi apagado com sucesso."

                        # Criar o banco de dados novamente
                        docker exec -it "$CONTAINER_ID" mysql -u root -p"$senha_mysql" -e "CREATE DATABASE strapi;"
...
criar_banco_mysql_humhub() {
    ...
    while :; do
        if CONTAINER_ID=$(docker ps -q --filter "name=mysql"); then
            if [ -n "$CONTAINER_ID" ]; then
                # Verificar se o banco de dados já existe
                if docker exec -it "$CONTAINER_ID" mysql -u root -p"$senha_mysql" -e "SHOW DATABASES LIKE 'humhub';" | grep -qw "humhub"; then
                    echo "O banco de dados humhub já existe."

                    read -p "Deseja apagar e criar um novo banco de dados? (Y/N): " resposta
                    if [ "$resposta" == "Y" ] || [ "$resposta" == "y" ]; then
                        # Apagar o banco de dados
                        docker exec -it "$CONTAINER_ID" mysql -u root -p"$senha_mysql" -e "DROP DATABASE humhub;"
                        echo "Banco de dados humhub apagado com sucesso."

                        # Criar o banco de dados novamente
                        docker exec -it "$CONTAINER_ID" mysql -u root -p"$senha_mysql" -e "CREATE DATABASE humhub;"
                        echo "Banco de dados humhub criado com sucesso."
                    else
                        echo "Usando o banco de dados existente."
                    fi
                    break
...
echo -en "\e[33mDigite o endereço de Email (ex: contato@blackhat.vip): \e[0m" && read -r email_teste
echo ""

echo -e "\e[97mPasso$amarelo 2/5\e[0m"
echo -e "$amarelo--> Caso não tiver um usuario do email, use o proprio email abaixo"
echo -en "\e[33mDigite o usuário de Email (ex: oriondesign ou contato@blackhat.vip): \e[0m" && read -r user_teste
echo ""
...
while true; do
    ...
    echo -en "\e[33mDigite o Dominio para o Portainer (ex: portainer.blackhat.vip): \e[0m" && read -r url_portainer
    echo ""
    ...
    echo -en "\e[33mDigite um endereço de Email válido (ex: contato@blackhat.vip): \e[0m" && read -r email_ssl
    echo ""
...
while true; do
    ...
    echo -en "\e[33mDigite o Dominio para o Chatwoot (ex: chatwoot.blackhat.vip): \e[0m" && read -r url_chatwoot
    echo ""
    ...
    echo -en "\e[33mDigite o Email para SMTP (ex: contato@blackhat.vip): \e[0m" && read -r email_admin_chatwoot
    echo ""
    ...
    echo -e "$amarelo--> Caso não tiver um usuario do email, use o proprio email abaixo"
    echo -en "\e[33mDigite o Usuário para SMTP (ex: oriondesign ou contato@blackhat.vip): \e[0m" && read -r user_smtp_chatwoot
    echo ""
...
## --------------------------- FÓRUM BLACKHAT --------------------------- ##
  ...
  chatwoot_app:
    ...
    environment:
      ...
      - CHATWOOT_HUB_URL=https://blackhat.vip/setup#
...
while true; do
    ...
    echo -en "\e[33mDigite o Dominio para a Evolution API (ex: api.blackhat.vip): \e[0m" && read -r url_evolution
    echo ""
...
## --------------------------- FÓRUM BLACKHAT --------------------------- ##
  ...
  evolution_v2:
    ...
    deploy:
      ...
      labels:
      - traefik.enable=1
      - traefik.http.routers.evolution_v2.rule=Host(\`$url_evolution\`) ## Url da aplicação
...
STACK_NAME="evolution2"
stack_editavel # > /dev/null 2>&1
#docker stack deploy --prune --resolve-image always -c evolution2.yaml evolution > /dev/null 2>&1
...
## Dados da Aplicação:
echo -e "\e[32m[ Evolution API v2 ]\e[0m"
echo ""
...
while true; do
    ...
    echo -e "\e[97mPasso$amarelo 1/4\e[0m"
    echo -en "\e[33mDigite o Dominio para o MinIO (ex: minio.blackhat.vip): \e[0m" && read -r url_minio
    echo ""
    
    ##Pergunta o Dominio para o S3 do Minio
    echo -e "\e[97mPasso$amarelo 2/4\e[0m"
    echo -en "\e[33mDigite o Dominio para o Minio S3 (ex: s3.blackhat.vip): \e[0m" && read -r url_s3
    echo ""
...
while true; do
    ...
    echo -en "\e[33mDigite o Dominio para o Builder do Typebot (ex: typebot.blackhat.vip): \e[0m" && read -r url_typebot
    echo ""

    ##Pergunta o Dominio do Viewer
    echo -e "\e[97mPasso$amarelo 2/10\e[0m"
    echo -en "\e[33mDigite o Dominio para o Viewer do Typebot (ex: bot.blackhat.vip): \e[0m" && read -r url_viewer
    echo ""
    ...
    echo -en "\e[33mDigite o Email para SMTP (ex: contato@blackhat.vip): \e[0m" && read -r email_typebot
    echo ""

    ##Pergunta o usuário do Email SMTP
    echo -e "\e[97mPasso$amarelo 5/10\e[0m"
    echo -e "$amarelo--> Caso não tiver um usuario do email, use o proprio email abaixo"
    echo -en "\e[33mDigite o Usuário para SMTP (ex: oriondesign ou contato@blackhat.vip): \e[0m" && read -r usuario_email_typebot
    echo ""
...
while true; do
    ...
    echo -en "\e[33mDigite o dominio para o N8N (ex: n8n.blackhat.vip): \e[0m" && read -r url_editorn8n
    echo ""
    
    ##Pergunta o Dominio do Webhook
    echo -e "\e[97mPasso$amarelo 2/2\e[0m"
    echo -en "\e[33mDigite o dominio para o Webhook do N8N (ex: webhook.blackhat.vip): \e[0m" && read -r url_webhookn8n
    echo ""
...
while true; do
    ...
    echo -e "\e[97mPasso$amarelo 1/3\e[0m"
    echo -en "\e[33mDigite o dominio para o Flowise (ex: flowise.blackhat.vip): \e[0m" && read -r url_flowise
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/3\e[0m"
    echo -en "\e[33mDigite o dominio para o PgAdmin 4 (ex: pgadmin.blackhat.vip): \e[0m" && read -r url_PgAdmin_4
    echo ""
    
    ##Pergunta o Email para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/3\e[0m"
    echo -en "\e[33mDigite um email para o PgAdmin 4 (ex: contato@blackhat.vip): \e[0m" && read -r user_PgAdmin_4
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/4\e[0m"
    echo -en "\e[33mDigite o dominio para o Nocobase (ex: nocobase.blackhat.vip): \e[0m" && read -r url_nocobase
    echo ""
    
    ##Pergunta o Email para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/4\e[0m"
    echo -en "\e[33mDigite um email para o Nocobase (ex: contato@blackhat.vip): \e[0m" && read -r mail_nocobase
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/1\e[0m"
    echo -en "\e[33mDigite o dominio para o Botpress (ex: botpress.blackhat.vip): \e[0m" && read -r url_botpress
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/2\e[0m"
    echo -en "\e[33mDigite o dominio para o Wordpress (ex: blackhat.vip ou loja.blackhat.vip): \e[0m" && read -r url_wordpress
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/6\e[0m"
    echo -en "\e[33mDigite o dominio para o Baserow (ex: baserow.blackhat.vip): \e[0m" && read -r url_baserow
    echo ""

    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/6\e[0m"
    echo -en "\e[33mDigite o Email para SMTP (ex: contato@blackhat.vip): \e[0m" && read -r mail_baserow
    echo ""

    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 3/6\e[0m"
    echo -en "\e[33mDigite o Usuário para SMTP (ex: oriondesign ou contato@blackhat.vip): \e[0m" && read -r user_baserow
    echo ""
...
while true; do
    ...
    echo -e "\e[97mPasso$amarelo 1/2\e[0m"
    echo -en "\e[33mDigite o dominio para o RabbitMQ (ex: rabbitmq.blackhat.vip): \e[0m" && read -r url_rabbitmq
    echo ""
...
while true; do
    ...
    echo -e "\e[97mPasso$amarelo 1/1\e[0m"
    echo -en "\e[33mDigite o dominio para o Uptime Kuma (ex: uptimekuma.blackhat.vip): \e[0m" && read -r url_uptimekuma
    echo ""
...
while true; do
    ...
    echo -e "\e[97mPasso$amarelo 1/6\e[0m"
    echo -en "\e[33mDigite o dominio para o Cal (ex: calcom.blackhat.vip): \e[0m" && read -r url_calcom
    echo ""
    
    ## Pergunta o email SMTP
    echo -e "\e[97mPasso$amarelo 2/6\e[0m"
    echo -en "\e[33mDigite o Email para SMTP (ex: contato@blackhat.vip): \e[0m" && read -r email_calcom
    echo ""

    ## Pergunta o Ususario SMTP
    echo -e "\e[97mPasso$amarelo 3/6\e[0m"
    echo -e "$amarelo--> Caso não tiver um usuario do email, use o proprio email abaixo"
    echo -en "\e[33mDigite o Usuario para SMTP (ex: oriondesign ou contato@blackhat.vip): \e[0m" && read -r user_calcom
    echo ""
...
while true; do
    ...
    ## Pergunta o Dominio da ferramenta
    echo -e "\e[97mPasso$amarelo 1/4\e[0m"
    echo -en "\e[33mDigite o Dominio para o Mautic (ex: mautic.blackhat.vip): \e[0m" && read -r url_mautic
    echo ""
    ...
    echo -e "\e[97mPasso$amarelo 3/4\e[0m"
    echo -en "\e[33mDigite o Email de admin: (ex: contato@blackhat.vip): \e[0m" && read -r email_mautic
    echo ""
...
while true; do
    ...
    ## Pergunta o Dominio da ferramenta
    echo -e "\e[97mPasso$amarelo 1/3\e[0m"
    echo -en "\e[33mDigite o dominio para o Appsmith (ex: appsmith.blackhat.vip): \e[0m" && read -r url_appsmith
    echo ""
...
while true; do
    ...
    read -r ip _ <<<$(hostname -I)
    echo -e "\e[97mPasso$amarelo 1/2\e[0m"
    echo -en "\e[33mDigite o ip da vps (seu ip: $ip) ou dominio para Qdrant (ex: qdrant.blackhat.vip): \e[0m" && read -r ip_vps
    echo ""
...
while true; do
    ...
    ## Pergunta o Dominio da ferramenta
    echo -e "\e[97mPasso$amarelo 1/3\e[0m"
    echo -en "\e[33mDigite o Dominio para o WoofedCRM (ex: woofedcrm.blackhat.vip): \e[0m" && read -r url_woofed
    echo ""
...
while true; do
    ...
    ## Pergunta o Dominio da ferramenta
    echo -e "\e[97mPasso$amarelo 1/6\e[0m"
    echo -en "\e[33mDigite o Dominio para o Formbricks (ex: formbricks.blackhat.vip): \e[0m" && read -r url_formbricks
    echo ""
    
    ## Pergunta o Email SMTP
    echo -e "\e[97mPasso$amarelo 2/6\e[0m"
    echo -en "\e[33mDigite um Email para o SMTP (ex: contato@blackhat.vip): \e[0m" && read -r email_formbricks
    echo ""

    ## Pergunta o User SMTP
    echo -e "\e[97mPasso$amarelo 3/6\e[0m"
    echo -e "$amarelo--> Caso não tiver um usuario do email, use o proprio email abaixo"
    echo -en "\e[33mDigite o Usuario do SMTP (ex: oriondesign ou contato@blackhat.vip): \e[0m" && read -r user_smtp_formbricks
    echo ""
...
## --------------------------- FÓRUM BLACKHAT --------------------------- ##
  ...
  formbricks:
    ...
    environment:
      ...
      ## Solicitar licenta Self-hosting --> https://blackhat.vip/formbricks_licence/ <-- ##
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/1\e[0m"
    echo -en "\e[33mDigite o dominio para o NocoDB (ex: nocodb.blackhat.vip): \e[0m" && read -r url_nocodb
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/1\e[0m"
    echo -en "\e[33mDigite o dominio para o Langfuse (ex: langfuse.blackhat.vip): \e[0m" && read -r url_langfuse
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/1\e[0m"
    echo -en "\e[33mDigite o dominio para o Metabase (ex: metabase.blackhat.vip): \e[0m" && read -r url_metabase
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/1\e[0m"
    echo -en "\e[33mDigite o dominio para o Odoo (ex: odoo.blackhat.vip): \e[0m" && read -r url_odoo
    echo ""
...
## --------------------------- FÓRUM BLACKHAT --------------------------- ##
  ...
  chatwoot_app:
    image: francisbreit/chatwoot-n:v3.9.5-pt-br ## Versão do Chatwoot
    command: bundle exec rails s -p 3000 -b 0.0.0.0
    entrypoint: docker/entrypoints/rails.sh
...
while true; do
    ...
    echo -en "\e[33mDigite o Dominio para a Uno API (ex: unoapi.blackhat.vip): \e[0m" && read -r url_unoapi
    echo ""

    ##Pergunta o Dominio do Chatwoot
    echo -e "\e[97mPasso$amarelo 2/11\e[0m"
    echo -en "\e[33mDigite o Dominio do Chatwoot já instalado (ex: chatwoot.blackhat.vip): \e[0m" && read -r url_chatwoot_uno
    echo ""
...
while true; do
    ...
    echo -e "\e[97mPasso$amarelo 3/5\e[0m"
    echo -en "\e[33mDigite o dominio do Chatwoot (ex: chatwoot.blackhat.vip): \e[0m" && read -r dominio_chatwoot
    echo ""

    ##Pergunta Dominio do Quepasa
    echo -e "\e[97mPasso$amarelo 4/5\e[0m"
    echo -en "\e[33mDigite o dominio do Quepasa (ex: quepasa.blackhat.vip): \e[0m" && read -r dominio_quepasa
    echo ""

    ##Pergunta Email do Quepasa
    echo -e "\e[97mPasso$amarelo 5/5\e[0m"
    echo -en "\e[33mDigite o email do Quepasa (ex: contato@blackhat.vip): \e[0m" && read -r email_quepasa
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/2\e[0m"
    echo -en "\e[33mDigite o dominio para o Quepasa (ex: quepasa.blackhat.vip): \e[0m" && read -r url_quepasa
    echo ""

    ##Pergunta o email para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/2\e[0m"
    echo -en "\e[33mDigite o email para o Quepasa (ex: contato@blackhat.vip): \e[0m" && read -r email_quepasa
    echo ""
...
## --------------------------- FÓRUM BLACKHAT --------------------------- ##
    ...
    quepasa:
        ...
        environment:
            ...
            ## Webhook
            #- WEBHOOK_QUEPASA=webhook.blackhat.vip/webhook/quepasa
            #- WEBHOOK_TESTE_QUEPASA=n8n.blackhat.vip/webhook-test/quepasa
...
while true; do
    ...
    echo -e "\e[97mPasso$amarelo 1/10\e[0m"
    echo -en "\e[33mDigite o dominio para o Dify AI (ex: dify.blackhat.vip): \e[0m" && read -r url_dify
    echo ""

    ##Pergunta o Dominio do Qdrant
    read -r ip _ <<<$(hostname -I)
    echo -e "\e[97mPasso$amarelo 2/10\e[0m"
    echo -en "\e[33mDigite o dominio do Qdrant (ex: http://$ip  ou http://qdrant.blackhat.vip): \e[0m" && read -r url_quedrant
    echo ""
    ...
    ##Pergunta o Email SMTP
    echo -e "\e[97mPasso$amarelo 4/10\e[0m"
    echo -en "\e[33mDigite o Email para SMTP (ex: contato@blackhat.vip): \e[0m" && read -r email_dify
    echo ""

    ##Pergunta o usuário do Email SMTP
    echo -e "\e[97mPasso$amarelo 5/10\e[0m"
    echo -e "$amarelo--> Caso não tiver um usuario do email, use o proprio email abaixo"
    echo -en "\e[33mDigite o Usuário para SMTP (ex: oriondesign ou contato@blackhat.vip): \e[0m" && read -r user_email_dify
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/2\e[0m"
    echo -en "\e[33mDigite o dominio para o WebUI Ollama (ex: ollama.blackhat.vip): \e[0m" && read -r url_ollama
    echo ""

    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/2\e[0m"
    echo -en "\e[33mDigite o dominio para a API Ollama (ex: apiollama.blackhat.vip): \e[0m" && read -r url_apiollama
    echo ""
...
while true; do
    ...
    echo -en "\e[33mDigite o dominio para o Affine (ex: affine.blackhat.vip): \e[0m" && read -r url_affine
    echo ""

    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/7\e[0m"
    echo -en "\e[33mDigite o Email de Admin (ex: contato@blackhat.vip): \e[0m" && read -r email_affine
    echo ""
    ...
    echo -en "\e[33mDigite a Email SMTP (ex: contato@blackhat.vip): \e[0m" && read -r email_smtp_affine
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/6\e[0m"
    echo -en "\e[33mDigite o dominio para o Docuseal (ex: docuseal.blackhat.vip): \e[0m" && read -r url_docuseal
    echo ""

    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/6\e[0m"
    echo -en "\e[33mDigite a Email SMTP (ex: contato@blackhat.vip): \e[0m" && read -r email_smtp_docuseal
    echo ""

    ##Pergunta o usuário do Email SMTP
    echo -e "\e[97mPasso$amarelo 3/6\e[0m"
    echo -e "$amarelo--> Caso não tiver um usuario do email, use o proprio email abaixo"
    echo -en "\e[33mDigite o Usuário para SMTP (ex: oriondesign ou contato@blackhat.vip): \e[0m" && read -r user_smtp_docuseal
    echo ""
...
while true; do
    ...
    echo -en "\e[33mDigite o dominio para o Directus (ex: directus.blackhat.vip): \e[0m" && read -r url_directus
    echo ""

     ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/9\e[0m"
    echo -en "\e[33mDigite a Email de Admin (ex: contato@blackhat.vip): \e[0m" && read -r email_directus
    echo ""
    ...
    echo -en "\e[33mDigite a Email SMTP (ex: contato@blackhat.vip): \e[0m" && read -r email_smtp_directus
    echo ""
...
while true; do
    ...
    ## Pergunta o Dominio da ferramenta
    echo -e "\e[97mPasso$amarelo 1/5\e[0m"
    echo -en "\e[33mDigite o Dominio para o VaultWarden (ex: vaultwarden.blackhat.vip): \e[0m" && read -r url_vaultwarden
    echo ""
    
    ## Pergunta o Email SMTP
    echo -e "\e[97mPasso$amarelo 2/5\e[0m"
    echo -en "\e[33mDigite um Email para o SMTP (ex: contato@blackhat.vip): \e[0m" && read -r email_vaultwarden
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para aplicação
    echo -e "\e[97mPasso$amarelo 1/4\e[0m"
    echo -en "\e[33mDigite o Dominio para o Grafana (ex: grafana.blackhat.vip): \e[0m" && read -r url_grafana
    echo ""

    ##Pergunta o Dominio para aplicação
    echo -e "\e[97mPasso$amarelo 2/4\e[0m"
    echo -en "\e[33mDigite o Dominio para o Prometheus (ex: prometheus.blackhat.vip): \e[0m" && read -r url_prometheus
    echo ""

    ##Pergunta o Dominio para aplicação
    echo -e "\e[97mPasso$amarelo 3/4\e[0m"
    echo -en "\e[33mDigite o Dominio para o cAdvisor (ex: cadvisor.blackhat.vip): \e[0m" && read -r url_cadvisor
    echo ""

    ##Pergunta o Dominio para aplicação
    echo -e "\e[97mPasso$amarelo 4/4\e[0m"
    echo -en "\e[33mDigite o Dominio para o NodeExporter (ex: node.blackhat.vip): \e[0m" && read -r url_nodeexporter
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/3\e[0m"
    echo -en "\e[33mDigite o dominio para o NextCloud (ex: nextcloud.blackhat.vip): \e[0m" && read -r url_nextcloud
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/1\e[0m"
    echo -en "\e[33mDigite o dominio para o Strapi (ex: strapi.blackhat.vip): \e[0m" && read -r url_strapi
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/2\e[0m"
    echo -en "\e[33mDigite o dominio para o PhpMyAdmin (ex: phpmyadmin.blackhat.vip): \e[0m" && read -r url_phpmyadmin
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio do Builder
    echo -e "\e[97mPasso$amarelo 1/10\e[0m"
    echo -en "\e[33mDigite o Dominio para o Supabase (ex: supabase.blackhat.vip): \e[0m" && read -r url_supabase
    echo ""
    ...
    ##Pergunta o Email SMTP
    echo -e "\e[97mPasso$amarelo 4/10\e[0m"
    echo -en "\e[33mDigite o Email para SMTP (ex: contato@blackhat.vip): \e[0m" && read -r email_supabase
    echo ""

    ##Pergunta o usuário do Email SMTP
    echo -e "\e[97mPasso$amarelo 5/10\e[0m"
    echo -e "$amarelo--> Caso não tiver um usuario do email, use o proprio email abaixo"
    echo -en "\e[33mDigite o Usuário para SMTP (ex: oriondesign ou contato@blackhat.vip): \e[0m" && read -r usuario_email_supabase
    echo ""
...
## --------------------------- FÓRUM BLACKHAT --------------------------- ##
  ...
  studio:
    ...
    #image: supabase/studio:20240422-5cf8f30 ## Versão da imagem
...
## --------------------------- FÓRUM BLACKHAT --------------------------- ##
  ...
  functions:
    ...
    image: supabase/edge-runtime:v1.54.2 ## Versão da imagem
    command:
      - start
      - '--main-service'
...
while true; do
    ...
    ##Pergunta o Dominio para aplicação
    echo -e "\e[97mPasso$amarelo 1/3\e[0m"
    echo -en "\e[33mDigite o Dominio para o Ntfy (ex: ntfy.blackhat.vip): \e[0m" && read -r url_ntfy
    echo ""
...
while true; do
    ...
    echo -en "\e[33mDigite o Dominio para o Lowcoder (ex: lowcoder.blackhat.vip): \e[0m" && read -r url_lowcoder
    echo ""
    ...
    echo -en "\e[33mDigite o Email para SMTP (ex: contato@blackhat.vip): \e[0m" && read -r email_smtp_lowcoder
    echo ""

    ## Pergunta o Ususario SMTP
    echo -e "\e[97mPasso$amarelo 5/8\e[0m"
    echo -e "$amarelo--> Caso não tiver um usuario do email, use o proprio email abaixo"
    echo -en "\e[33mDigite o Usuario para SMTP (ex: oriondesign ou contato@blackhat.vip): \e[0m" && read -r user_smtp_lowcoder
    echo ""
...
## Usa o serviço wait_lowcoder para verificar se o serviço esta online
wait_lowcoder
...
while true; do
    ...
    ## Pergunta o Dominio da ferramenta
    echo -e "\e[97mPasso$amarelo 1/10\e[0m"
    echo -en "\e[33mDigite o Dominio para o HumHub (ex: humhub.blackhat.vip): \e[0m" && read -r url_humhub
    echo ""
    ...
    ## Pergunta o email da ferramenta
    echo -e "\e[97mPasso$amarelo 4/10\e[0m"
    echo -en "\e[33mDigite o Email do Admin: (ex: contato@blackhat.vip): \e[0m" && read -r email_humhub
    echo ""
    ...
    ## Pergunta o Email SMTP
    echo -e "\e[97mPasso$amarelo 6/10\e[0m"
    echo -en "\e[33mDigite um Email para o SMTP (ex: contato@blackhat.vip): \e[0m" && read -r email_smtp_humhub
    echo ""

    ## Pergunta o User SMTP
    echo -e "\e[97mPasso$amarelo 7/10\e[0m"
    echo -e "$amarelo--> Caso não tiver um usuario do email, use o proprio email abaixo"
    echo -en "\e[33mDigite o Usuario do SMTP (ex: oriondesign ou contato@blackhat.vip): \e[0m" && read -r user_smtp_humhub
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio do Builder
    echo -e "\e[97mPasso$amarelo 1/3\e[0m"
    echo -en "\e[33mDigite o Dominio para LangFlow (ex: langflow.blackhat.vip): \e[0m" && read -r url_langflow
    echo ""
...
if [ $? -eq 0 ]; then
        pegar_senha_postgres > /dev/null 2>&1
        criar_banco_postgres_langflow #> /dev/null 2>&1
    else
        ferramenta_postgres #> /dev/null 2>&1
        pegar_senha_postgres > /dev/null 2>&1
        criar_banco_postgres_langflow #> /dev/null 2>&1
...
key_langflow=$(openssl rand -base64 33 | tr -d '\n' | tr '+/' '-_' | cut -c1-44)
...
## --------------------------- FÓRUM BLACKHAT --------------------------- ##
  ...
  langflow:
    ...
    environment:
      ...
      ## Diretório
      - LANGFLOW_CONFIG_DIR=/app/flowise
...
## Usa o serviço wait_langflow para verificar se o serviço esta online
wait_langflow
...
while true; do
    ...
    ## Pergunta o Dominio da ferramenta
    echo -e "\e[97mPasso$amarelo 1/3\e[0m"
    echo -en "\e[33mDigite o Dominio para o Zep (ex: zep.blackhat.vip): \e[0m" && read -r url_zep
    echo ""
...
if [ $? -eq 0 ]; then
    echo ""
    pegar_senha_pgvector > /dev/null 2>&1
    criar_banco_pgvector_zep #> /dev/null 2>&1
else
    ferramenta_pgvector #> /dev/null 2>&1
    pegar_senha_pgvector > /dev/null 2>&1
    criar_banco_pgvector_zep #> /dev/null 2>&1
...
echo -e "\e[97mDominio:\e[33m https://$url_zep\e[0m"
echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/1\e[0m"
    echo -en "\e[33mDigite o dominio para o OpenProject (ex: openproject.blackhat.vip): \e[0m" && read -r url_openproject
    echo ""
...
if [ $? -eq 0 ]; then
        sleep 1
        pegar_senha_postgres > /dev/null 2>&1
        criar_banco_postgres_openproject #> /dev/null 2>&1
...
## Usa o serviço wait_openproject para verificar se o serviço esta online
wait_openproject
        ...
        evolution.beta)
            if verificar_docker_e_portainer_traefik; then
                ...
                if grep -q "Token: .\+" /root/dados_vps/dados_portainer; then
                    ...
                    APP_ORION="ferramenta_evolution_beta"
                    ferramenta_evolution_beta
                fi
